...
const HAPTICS_DEBUG_MODE_ENABLED = import.meta.env.DEV;

const HAPTIC_EVENT_PATTERN_KEYS: HapticEventMap = {
...
const THROTTLED_HAPTIC_EVENTS = new Set<HapticEventName>([
