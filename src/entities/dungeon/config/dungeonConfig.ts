...
export const DUNGEON_THEME = {
	STONE: {
		BASE_COLOR: DUNGEON_THEME_COLORS.STONE_BASE,
		DETAIL_COLOR: DUNGEON_THEME_COLORS.STONE_DETAIL,
	},
	LIGHTING: {
		TORCH_COLOR: DUNGEON_THEME_COLORS.TORCH_LIGHT,
	...
	RUNES: {
		SEALED: DUNGEON_THEME_COLORS.RUNE_SEALED,
		OPEN: DUNGEON_THEME_COLORS.RUNE_OPEN,
		ACTIVE: DUNGEON_THEME_COLORS.RUNE_ACTIVE,
	},
} as const;
